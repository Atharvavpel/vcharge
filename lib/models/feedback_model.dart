...
class FeedbackModel {
  ...
  FeedbackModel({this.feedbackId, this.feedbackCustomerId, this.feedbackStationId, this.feedbackHostId, this.feedbackVendorId, this.feedbackText, this.feedbackRating, this.feedbackDate, this.feedbackStatus, this.createDate, this.modifiedDate, this.createBy, this.modifiedBy, this.active});
