                                      ...
                                      children: [
                                        Card(
                                          ...
                                          child: InkWell(
                                            ...
                                            child: CircleAvatar(
                                              backgroundColor: Color.fromARGB(255, 179, 223, 102),
                                              radius: Get.height * 0.07,
                                              child: Center(
                                                child: Text('Start', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: Get.height * 0.03),),
                                              ),
                                            ),
                                          ),
                                        ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Text('Estimated Time', style: TextStyle(fontWeight: FontWeight.bold, fontSize: Get.width * 0.045),),
                                      Text('21 Mins',style: TextStyle(fontSize: Get.width * 0.045),),
                                    ],
                                  ),
                                  ...
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Text('Estimated Cost',style: TextStyle(fontWeight: FontWeight.bold, fontSize: Get.width * 0.045),),
                                      Text('Rs. 190 Inc Taxes',style: TextStyle(fontSize: Get.width * 0.045),),
                                    ],
                                  ),
                                  ...
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Text('Estimated Units', style: TextStyle(fontWeight: FontWeight.bold, fontSize: Get.width * 0.045),),
                                      Text('28 Units', style: TextStyle(fontSize: Get.width * 0.045),),
                                    ],
                                  ),
                                ],
                              ),
